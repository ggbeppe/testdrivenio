...
class TestUserService(BaseTestCase):
    ...
    def test_add_user_not_admin(self):
        ...
        with self.client:
            ...
            self.assertTrue(
                data['message'] == 'You do not have permissions to do that.')
            self.assertEqual(response.status_code, 401)

    def test_single_user(self):
        """Ensure get single user behaves correctly."""
        user = add_user('michael', 'michael@mherman.org', 'secretpassword')
        with self.client:
    ...
    def test_single_user_incorrect_id(self):
        """Ensure error is thrown if the if does not exist."""
        with self.client:
    ...
    def test_all_users(self):
        ...
        add_user('michael', 'michael@mherman.org', 'secretpassword')
        add_user('fletcher', 'fletcher@notreal.com', 'secretpassword2')
        with self.client:
